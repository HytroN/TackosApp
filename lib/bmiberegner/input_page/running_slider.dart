...
class RunningManSlider extends StatefulWidget {
  final VoidCallback onSubmit;
  final AnimationController submitAnimationController;

  const RunningManSlider(
      {Key key, this.onSubmit, this.submitAnimationController})
      : super(key: key);

  @override
  _RunningManSliderState createState() => _RunningManSliderState();
}

class _RunningManSliderState extends State<RunningManSlider>
...
class ManRunningIcon extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(
